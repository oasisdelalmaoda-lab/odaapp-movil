...
const VERSION = 'oda-app-v12';
const SHELL = ['./', './index.html', './app-manifest.json', './app-icon-192.png', './app-icon-512.png', './app-icon-192-maskable.png', './app-icon-512-maskable.png'];
